...
describe('Test filter products function', () => {
	it('Filter by brand -(Valid)', () => {
		...
		var result = mainPageFunctions.filterProducts(products, 'brand', 'zog');
	...
	it('Filter by brand -(Invalid)', () => {
		...
		var result = mainPageFunctions.filterProducts(products, 'brand', 'BMW');
	...
	it('Filter by category -(Valid)', () => {
		...
		var result = mainPageFunctions.filterProducts(products, 'category', 'dairy');
		expect(result).toStrictEqual(expected);
	});
	...
	it('Filter by category -(Invalid)', () => {
		...
		var result = mainPageFunctions.filterProducts(products, 'category', 'popcorn');
		expect(result).toStrictEqual([]);
	});
});
...
describe('Test find index by ID if the product', () => {
	it('Find index of the product - (Valid Test)', () => {
		...
		var result = mainPageFunctions.findIndexProducdID(products, 1);
	...
	it('Find index of the product - (Invalid Test)', () => {
		...
		var result = mainPageFunctions.findIndexProducdID(products, 7);
...
describe('Test available products function', () => {
	it('No available products (Invalid)', () => {
		...
		var result = mainPageFunctions.getAvailableProducts(products);
		expect(result).toStrictEqual([]);
	});
